...
export default function ContactPage() {
  ...
  return (
    ...
    <div className="p-2 bg-[url('/bgImg.png')] bg-cover bg-center min-h-screen flex flex-col items-center text-white">
      ...
      {/* --- MAIN CONTENT - RESTRUCTURED FOR BETTER UI & ANIMATION --- */}
      <main className="container mx-auto px-6 pt-32 pb-16 flex-grow flex items-center justify-center">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 p-8 bg-white/5 border border-white/30 rounded-2xl shadow-2xl backdrop-blur-md">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="mt-2 text-gray-400 leading-relaxed">
                  Reach out to us directly through the following channels. We aim to respond to all inquiries within 24-48 hours.
                </p>
              </div>
              <div className="space-y-4 text-left">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:valence.contactus@gmail.com" className="text-green-400 hover:underline">
                      valence.contactus@gmail.com
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
            ...
            {/* --- CONTACT FORM - STYLED TO MATCH YOUR UI --- */}
            <div>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={status.submitting} className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:bg-gray-400 disabled:cursor-not-allowed">
                  {status.submitting ? 'Sending...' : 'Send Message'}
                </button>
                {status.success && <p className="text-green-400 font-semibold text-center mt-2">Message sent successfully!</p>}
